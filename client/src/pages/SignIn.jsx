  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button className='bg-teal-700 text-white p-3 rounded-lg uppercase hover:opacity-85 disabled:opacity-75 cursor-pointer'>{loading? "loading...." : "Sign In"}</button>
        <OAuth></OAuth>
      </form>
      ...
      {error && <p className='mt-5 text-sm text-red-500'>ERROR: {error}</p>}
    </div>
  )
}
