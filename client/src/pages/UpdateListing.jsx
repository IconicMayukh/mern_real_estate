        ...
        <main className='p-3 max-w-5xl mx-auto'>
            ...
            <form className='flex flex-col sm:flex-row gap-16' onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 cursor-pointer text-center disabled:cursor-not-allowed'>{loading ? 'Updating...' : 'Update Lisitng'}</button>
